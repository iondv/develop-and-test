...
const you = Object.assign(require('../../util/list'),
  ...
  require('../../util/filter'),
  require('../../util/frame'));
const createdElement = 'test.txt';
const path = require('path');
const fs = require('fs');
const process = require('process');

describe.skip('Проверка операций над типом 12 "Файл"', function () { //TODO Не может найти файл
  before(function () {
    browser.get(browser.params.serverURL + '/registry/develop-and-test@class_file');
    browser.wait(EC.urlIs(browser.params.serverURL + '/registry/develop-and-test@class_file'));
  });
  describe('Шаг 1. Создание объекта соответствующего класса', function () {
    ...
    it('Проверка появления id нового элемента', function () {
      var id = 'a_develop-and-test_class_file_id';
